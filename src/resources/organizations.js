              ...
              return (
                <React.Fragment key={record.id}>
                  <TableRow sx={{ 
                    ...
                    <TableCell>{record.orgName}</TableCell>
                    <TableCell>{record.mnemonic}</TableCell>
                    <TableCell>{record.authorizationScheme}</TableCell>
                    <TableCell>{record.supportedBy}</TableCell>
                    <TableCell>{record.managedBy}</TableCell>
                    <TableCell>{record.serviceOffering}</TableCell>
                    <TableCell>
                      <Chip
                  ...
                  {isExpanded && (
                    <TableRow>
                      <TableCell colSpan={9} sx={{ padding: 0, border: 'none' }}>
                        <Box sx={{ 
                          p: 2, 
